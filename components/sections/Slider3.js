						...
						<div className="col-xl-8 col-lg-7">
							<div className="slider-content">
								<div className="heading">
									<h2 className="title homeTitle">One Place to Buy <span>Executions</span>
									</h2>

									<p className="subtitle body-1 wow fadeIn" data-wow-delay=".8s" data-wow-duration="2000ms">The all-in-one software that allows you to buy, manage, and sell your Tax Sale Properties</p>
								</div>
								<Link href="#" className="tf-btn primary size-2">Get Started</Link>
							</div>
						</div>
